...
namespace Cocon90.Lib.Util.Window.Input.InputSimulator
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Dispatches the specified list of <see cref="INPUT"/> messages in their specified order by issuing a single called to <see />.
        /// </summary>
